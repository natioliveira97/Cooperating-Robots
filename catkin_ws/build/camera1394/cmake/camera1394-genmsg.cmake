...
get_filename_component(_filename "/home/scara/Cooperating-Robots/catkin_ws/src/camera1394/srv/GetCameraRegisters.srv" NAME_WE)
add_custom_target(_camera1394_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera1394" "/home/scara/Cooperating-Robots/catkin_ws/src/camera1394/srv/GetCameraRegisters.srv" ""
)

get_filename_component(_filename "/home/scara/Cooperating-Robots/catkin_ws/src/camera1394/srv/SetCameraRegisters.srv" NAME_WE)
add_custom_target(_camera1394_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera1394" "/home/scara/Cooperating-Robots/catkin_ws/src/camera1394/srv/SetCameraRegisters.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/camera1394)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/camera1394\")")
  # install generated code
  install(
